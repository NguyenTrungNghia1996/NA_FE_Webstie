...
const data_info = ref({
  ...
  description:
    "Công ty TNHH thương mại dịch vụ giáo dục Nguyên Anh là doanh nghiệp chuyên cung cấp, xây dựng các giải pháp phần mềm, phần cứng trong nhiều lĩnh vực hàng đầu tại Việt Nam. Với đội ngũ nhân viên dày dạn kinh nghiệm phát triển các sản phẩm và dịch vụ chúng tôi tự tin đem tới trải nhiệm tuyệt vời nhất cho khách hàng...",
  description2:
    '"Với lực lượng nhân sự trẻ trung, năng động, đam mê công nghệ, chúng tôi tự tin để thực hiện các dự án công nghệ thông tin của khách hàng với chất lượng tốt nhất và chi phí hợp lý nhất."',
  ...
  slides: [
    {
      ...
      description:
        "eNetViet được thiết kế và xây dựng nhằm tạo nên một cộng đồng giáo dục gắn kết giữa nhà quản lý (cán bộ Sở/ Phòng Giáo dục, Nhà trường) với Giáo viên và Phụ huynh nhằm mang lại...",
      url: "#",
...
const {
  ...
  error: error_product,
} = await RestApi.product.get_proudct();
const {
  data: source_service,
  status:status_service,
  error:error_service,
} = await RestApi.product.get_service();
